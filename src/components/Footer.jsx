      ...
      <div style={{height:'300px'}} className='container mt-5 w-100 '>
        <div className="footer-content d-flex justify-content-between">
          <div style={{width:'400px'}} className="media">
              <h5 className='d-flex'><i style={{height:'25px'}} className="fa-solid fa-truck-fast me-3"></i>Cart</h5>
          ...
          <div className="contact">
              ...
              <div className='icons d-flex justify-content-between mt-3'>
                <a href="https://react.dev/" target="_blank" style={{textDecoration:'none'}}><i class='fa-brands fa-twitter fa-1x'></i></a>
                <a href="https://react.dev/" target="_blank" style={{textDecoration:'none'}}><i class='fa-brands fa-instagram fa-1x'></i></a>
                <a href="https://react.dev/" target="_blank" style={{textDecoration:'none'}}><i class='fa-brands fa-facebook fa-1x'></i></a>
                <a href="https://react.dev/" target="_blank" style={{textDecoration:'none'}}><i class='fa-brands fa-linkedin fa-1x'></i></a>
                <a href="https://react.dev/" target="_blank" style={{textDecoration:'none'}}><i class='fa-brands fa-github fa-1x'></i></a>
                <a href="https://react.dev/" target="_blank" style={{textDecoration:'none'}}><i class='fa-brands fa-phone fa-1x'></i></a>
